...
<!-- Plugin description -->
**ASP Classic Language Support** provides comprehensive language support for Classic ASP (Active Server Pages) in JetBrains IDEs.

Features:
- Syntax highlighting for VBScript and ASP directives
- Code completion for ASP objects (Request, Response, Session, Application, Server)
- Code folding for ASP blocks and HTML structures
- Brace matching and automatic insertion
- Comment/uncomment support
- Structure view for ASP files
- File templates for new ASP files

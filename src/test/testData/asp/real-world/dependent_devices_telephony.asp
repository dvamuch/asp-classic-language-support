...
set deviceRs = deviceDalInstance.getTelephonyDownlinksWithServiceAndClient(switchId, pageNumber, rowsPerPage)
dim totalRows : totalRows = deviceDalInstance.getTelephonyDownlinksCount(switchId)
              ...
              <tr>
                <td class="article-top" colspan=2>
                  <div style="display: flex; align-items: center; justify-content: space-between;">
                    <div>Клиенты (Телефония) на зависимых устройствах для <a  href="/devices/deviceinfo.asp?SwitchID=<%=currentDeviceRs("device_id")%>"><%=currentDeviceRs("device_name")%></a></div>
                    <div><a href="/devices/dependent_devices.asp?SwitchID=<%=currentDeviceRs("device_id")%>">Зависимые устройства без телефонии</a></div>
                  </div>
                </td>
              </tr>
              <tr>
                <td  class="article-top" colspan=2>
                  <a  target="_blank" href="https://wiki.naukanet.ru/doku.php?id=tts:devices-dependent_devices_telephony">Об этой странице в Вики</a>
                <td>
              </tr>
              <tr class="boxtop">
                <td>
